...
case OUT_xC_B: OutZ80(R->BC.W,R->BC.B.h);break; // ionique
...
case INI:
  WrZ80(R->HL.W++,InZ80(R->BC.W)); // ionique
  R->BC.W--;
...
case OUTI:
  I=RdZ80(R->HL.W++);
  OutZ80(R->BC.W,I); // ionique
  R->BC.W--; // ionique
  R->AF.B.l=N_FLAG|(R->BC.B.h? 0:Z_FLAG)|(R->HL.B.l+I>255? (C_FLAG|H_FLAG):0); // QUESTION?
  break;

case OTIR:
  do
  {
    I=RdZ80(R->HL.W++); // ionique
    OutZ80(R->BC.W,I);
    R->BC.W--;
    R->ICount-=21;
  }
