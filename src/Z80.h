...
typedef struct
{
  ...
  uint16 IRequest;      /* Set to address of pending IRQ       */
...
/*************************************************************/
uint16 ExecZ80(register Z80 *R);

/** IntZ80() *************************************************/
/** This function will generate interrupt of given vector.  **/
/*************************************************************/
void IntZ80(register Z80 *R,register uint16 Vector);
